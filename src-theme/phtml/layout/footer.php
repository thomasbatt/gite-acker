<footer class="footer <?= $content['name'] ?>">
	<section class="wow slideInUp" data-wow-delay="1.2s" data-wow-offset="10">
        <div class="footer-scrolldown-arrow js-scrollTo" data-target="next">
        	<?php include get_template_directory() . "/phtml/components/svg-footer.php"; ?>
        	<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
    	</div>
	    <div class="footer-meta-links">
	        <a href="#" class="js-open-legales" data-fade="false">Mentions légales</a> | <a href="#" class="js-open-legales" data-fade="false">Charte de confidentialité</a><br/>    
			<span>© Copyright 2016 
