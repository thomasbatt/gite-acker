<footer class="footer">
	<section class="wow slideInUp" data-wow-delay="1.2s" data-wow-offset="10">
        ...
        <div class="footer-scrolldown-arrow transition display">
			<svg class="js-scrollTo" target="next" version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100px" height="185.667px" viewBox="0 0 80 185.667" enable-background="new 0 0 80 185.667" xml:space="preserve">
				<g>
