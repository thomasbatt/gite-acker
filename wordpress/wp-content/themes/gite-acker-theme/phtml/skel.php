...
@media screen and (max-width: 640px) {
  ...
  .footer-scrolldown-arrow svg {
    ...
    .footer-scrolldown-arrow svg path[id=roll], .footer-scrolldown-arrow svg path {
      display: none; }
  #page {
    /*		#acceuil{
			.content{
    ...
    #page #contact .content-contact {
      ...
      #page #contact .content-contact .img {
		...
		<link rel='stylesheet' href='<?php bloginfo('template_url')?>/css/vendors.min.css?v=1b8ba8dcd1c0'/>
		<link rel='stylesheet' href='<?php bloginfo('template_url')?>/css/website.min.css?v=1b8ba8dcd1c0'/>
	</head>
	...
	<script type='text/javascript' src='<?php bloginfo('template_url');?>/js/vendors.min.js?v=1b8ba8dcd1c0'></script>
	<script type='text/javascript' src='<?php bloginfo('template_url');?>/js/website.min.js?v=1b8ba8dcd1c0'></script>
</html>