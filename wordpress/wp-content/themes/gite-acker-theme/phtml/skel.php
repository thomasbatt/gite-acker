  ...
  #page #contact .content-contact {
    ...
    #page #contact .content-contact .img {
      display: none; } }
		...
		<link rel='stylesheet' href='<?php bloginfo('template_url')?>/css/vendors.min.css?v=1b76d5d62c90'/>
		<link rel='stylesheet' href='<?php bloginfo('template_url')?>/css/website.min.css?v=1b76d5d62c90'/>
	</head>
	...
	<script type='text/javascript' src='<?php bloginfo('template_url');?>/js/vendors.min.js?v=1b76d5d62c90'></script>
	<script type='text/javascript' src='<?php bloginfo('template_url');?>/js/website.min.js?v=1b76d5d62c90'></script>
</html>